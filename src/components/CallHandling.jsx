...
const CallHandling = () => {
    return (
        <section className="px-3">
            <div className="container-xl bg-skin-color md:py-[100px] sm:py-[80px] py-[50px] rounded-[32px] lg:mt-[140px] md:mt-[100px] mt-[90px]">
                <div className="container">
                    ...
                    <div className="row items-center justify-center">
                        {callHandling.map((obj, index) => <div className="lg:w-3/12 md:w-4/12 sm:w-6/12 w-full px-3 max-sm:flex max-sm:items-center max-sm:justify-center">
                            <div className="sm:max-w-[267px] w-full min-h-[60px] border border-[#0000001F] rounded-[16px] flex items-center justify-start gap-[10px] ps-[10px] md:mt-6 mt-4">
