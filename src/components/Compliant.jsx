...
const Compliant = () => {
    return (
        <section className="px-3" id="listen">
            <div className="container md:py-[100px] py-[50px] rounded-[32px] lg:mt-[140px] md:mt-[100px] mt-[90px] md:bg-full bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${compliantSecImg})` }}>
