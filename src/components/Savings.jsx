...
const Savings = () => {
    return (
        <section className="lg:px-6 px-5 lg:pb-[140px] md:pb-[100px] pb-[90px]">
            <div className="container-xl max-sm:px-3 lg:py-[100px] md:py-[80px] py-[50px] rounded-[32px] mt-[140px] md:bg-full bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${compliantSecImg})` }}>
                ...
                <div className="flex items-center justify-center w-full md:mt-[50px] mt-6 md:mb-[44px] mb-6">
                    <div className="max-w-[726px] flex flex-col items-center justify-center w-full bg-dark-green">
                        <div className="border-t border-l border-[#FEFEFE1F] bg-[#0F4851] py-[10px] sm:px-5 px-4 rounded-[16px] flex items-center justify-between w-full flex-wrap gap-3">
                        ...
                        <div className="border-t border-l border-[#FEFEFE1F] bg-[#0F4851] py-[10px] sm:px-5 px-4 rounded-[16px] flex items-center justify-between w-full flex-wrap gap-3 mt-5">
