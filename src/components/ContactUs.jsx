...
const ContactUs = () => {
    ...
    return (
        <section className="lg:pb-[140px] md:pb-[100px] pb-[90px] lg:px-6 px-5" id="contact">
            <div className="container-xl px-0 xl:bg-full bg-cover bg-center bg-no-repeat lg:py-[100px] md:py-[80px] py-[50px] rounded-[32px]" style={{ backgroundImage: `url(${contactUs})` }}>
                <div className="max-w-[752px] mx-auto px-4">
                    ...
                    <form className="md:gap-6 gap-4 flex flex-col">
                        ...
                        <div className="flex items-start justify-center flex-col gap-2 w-full">
                            <p className="font-lato font-normal text-base text-white-200 opacity-60">Message</p>
                        ...
                        <button className=" w-full min-h-[55px] text-dark-green bg-white-200 rounded-[99px] font-lato font-bold text-lg mt-[20px] border border-transparent hover:bg-dark-green hover:text-white ease-in-out duration-300 hover:shadow-xl hover:border hover:border-white-200" onClick={(e) => handleSubmit(e)}>Submit Now</button>
                    </form>
                </div>
            </div>
        </section>
